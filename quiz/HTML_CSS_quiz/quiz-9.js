const questions = [
  ...
  {
    question: "リポジトリへのアクセス権を他に与えるためにの機能は？",
    choices: ["ブランチ", "フォーク", "コミット", "プッシュ", "コラボレーター"],
    answer: "コラボレーター",
  },
  {
    question: "新しい機能を独立して開発するために作成するものは？",
    choices: ["ブランチ", "プルリクエスト", "コミット", "イシュー", "フォーク"],
    answer: "ブランチ",
  },
  {
    question: "他のリポジトリを自分のアカウントにコピーすることを？",
    choices: ["フォーク", "プッシュ", "コミット", "ブランチ", "イシュー"],
    answer: "フォーク",
  },
  {
    question: "GitHubのプルリクエスト機能でできることはどれですか？",
    choices: ["コードのマージ", "リポジトリの削除", "ローカルリポジトリの作成", "SSHキーの追加", "コミット履歴の編集"],
    answer: "コードのマージ",
  },
  {
    question: "GitHubのプロジェクトボード機能の主な用途は何ですか？",
    choices: ["タスク管理", "コードレビュー", "プルリクエスト作成", "コミットの管理", "リポジトリのフォーク"],
    answer: "タスク管理",
  },
  {
    question: "プルリクエストを作成するための最初のステップは？",
